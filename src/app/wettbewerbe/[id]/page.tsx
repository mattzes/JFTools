...
import { useApi, Person, Termin, Planung, Verfuegbarkeit } from "@/lib/api";
...
export default function WettbewerbPlanerPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!personen || !planung || !termine || !alleVerf) return <Spinner />;
  ...
  return <GruppenPlaner personen={personen} planung={planung} termine={termine} alleVerf={alleVerf} reload={reload} />;
}
